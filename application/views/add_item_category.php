...
<!---border: 1px solid #e8e8e8;-->
  ...
  <header class="panel_header">
    ...
    <h2 class="title pull-left" id="form-title">Create Item Category</h2>
    <div class="actions panel_actions pull-right">
      <!-- <a class="box_setting fa fa-cog" data-toggle="modal" href="#section-settings"></a> -->
    </div>
  </header>
  <div class="content-body">
    <form method="POST" action="<?php echo base_url('item_master/add_item_category') ?>" onsubmit="return validate();">
    <div class="row">
      ...
      <div class="row form-row ml-15 mr-15">
            <div class="col-xs-4">
              ...
              <input type="text" name="category_name" class="form-control text-field" id="category_name" value="" placeholder="Category name">
      ...
      <div class="col-xs-12  padding-bottom-30" style="margin-right: 20px;">
        <div class="text-center">
          <button type="submit" name="submit"  class="btn btn-default"><span class="fa fa-check" aria-hidden="true" style="margin-right: 5px;"></span>Create
          </button>
