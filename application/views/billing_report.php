        ...
        <tr>
          ...
          <td width="15%">
            ...
            <div style="display: flex;">
                ...
                <a  onclick="return billing_report_pdf()">
                ...
                <button id="new" onclick="return billing_report_excel();" class="btn btn-default dropdown-toggle" style="width: 90%;margin-right: 11px;margin-top: 5px;" data-toggle="dropdown" data-hover="dropdown">
          ...
          <td>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="form-group">
                      ...
                      <!--   <label>Select Allergy</label> -->
                        ...
                        <select class="form-control billign_report_patient text-field select2" name="allergy_type">

                            <option value="">Select Patient</option>
							<?php
								foreach($patients as $patients_list){
							?>
								<option value="<?php echo $patients_list->id ;?>"><?php echo $patients_list->fname."   ".$patients_list->lname;?></option>
							<?php } ?>
                ...
                <div class="col-lg-3">
                    <div class="form-group">
                        ...
                        <select class="form-control billign_report_type text-field select2" name="billign_report_type">
                ...
                <div class="col-lg-3">
                   <div class="form-group">
						...
						<select class="form-control billign_report_amount_status text-field select2" name="billign_report_amount_status">
               ...
               <div class="col-lg-3">
                   ...
                   <div class="form-group">                        
                        ...
                        <button id="new" class="btn btn-default" onclick="return billing_report_search();"><i class="fa fa-search"></i></button>    
      ...
      <table class="table table-patient">
        ...
        <thead>
            ...
            <tr>            
				...
				<th width="20%" class="text-center">Subscribe</th>
                <th width="20%" class="text-center">Subscribe Type</th>				
...
<script>    
 ...
 $(document).ready(function() {
    ...
    function billing_report_search(){

       var BASE_URL = '<?php echo base_url(); ?>';

       var patient_id = $(".billign_report_patient").val();

       var billign_report_type  = $(".billign_report_type").val();

       var billign_report_amount_status = $(".billign_report_amount_status").val();
          ...
          $("#padd").empty();
           ...
           $.ajax({
                ...
                url: BASE_URL+"billing_report/bill_report_search",

                data: 'patient_id='+patient_id+'&billign_report_type='+billign_report_type+'&billign_report_amount_status='+billign_report_amount_status,
    ...
    function billing_report_pdf(){
		...
		if($(".billign_report_patient").val() != ""){
			var patient_id = $(".billign_report_patient").val();
		}else{
			var patient_id = "";
		}

        if ($(".billign_report_type").val() !="") {
            var billign_report_type  = $(".billign_report_type").val();
        }else{
            var billign_report_type = "";
        }

        if ($(".billign_report_amount_status").val()!="") {
            var billign_report_amount_status = $(".billign_report_amount_status").val();
        }else{
            var billign_report_amount_status = "";
        }
        window.location.href='<?php echo base_url(); ?>'+'billing_report/billing_report_pdf?'+'patient_id='+patient_id+'&billign_report_type='+billign_report_type+'&billign_report_amount_status='+billign_report_amount_status

    }

    function billing_report_excel(){
		if($(".billign_report_patient").val() != ""){
			var patient_id = $(".billign_report_patient").val();
		}else{
			var patient_id = "";
        ...
        window.location.href='<?php echo base_url(); ?>'+'billing_report/download_excel?'+'patient_id='+patient_id+'&billign_report_type='+billign_report_type+'&billign_report_amount_status='+billign_report_amount_status
    }
