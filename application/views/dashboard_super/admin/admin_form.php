  ...
  <div class="col-lg-12 col-xs-12 p-0">
      ...
      <div class="row ml-10 mr-10 mb-10">
        <div class="col-12 col-md-6 form-group">
          ...
          <div class="row" style="margin-left:0px;">
            ...
            <div class="col-12 col-md-6">
              <div class="form-check">
                <input class="form-check-input" id="fearureCheck12" type="checkbox" name="feature[]" value="auditdump" <?php echo (in_array('auditdump',$feature)?'checked':'') ?> >
                <label class="form-check-label ml-10" for="fearureCheck11">
                  Audit Dump
                </label>
              </div>
    ...
    <div class="row ml-10 mr-10 mb-10">
      <div class="col-12 col-md-6 form-group">
         ...
         <input type="text" name="client_id" value="<?php echo $admin->client_id; ?>"  class="form-control text-field" id="client_id">
       </div>
      <div class="col-12 col-md-6 form-group">
         <label>Paypal Secret</label>
         <input type="text" name="secret" value="<?php echo $admin->secret; ?>" class="form-control text-field" id="secret">
       </div>
