          ...
          <td>
            ...
            <div class="col-lg-3">
              ...
              <div class="form-group">
                ...
                <select class="form-control auditdump_report_hospital text-field select2" name="auditdump_report_module">
                ...
                //  print_r($user);
                  foreach($user as $user_list){
                    ?>
                    <option value="<?php echo $user_list->user_id; ?>"><?php echo $user_list->hospitalname; ?> </option>
                  <?php } ?>
        ...
        <tbody id="padd">
          ...
          foreach ($auditdump as $auditdump_value) {
            ...
            <tr>
              ...
              <td><?php  $userdetail = $this->db->get_where("user",array('user_id'=>$auditdump_value->user))->row(); echo $userdetail->firstname.'  '.$userdetail->lastname; ?>
                <?php if($auditdump_value->role == 11 ){
                  ...
                  $patient_detail = $this->db->get_where("patient",array('id'=>$auditdump_value->user))->row(); echo $patient_detail->fname.'  '.$patient_detail->lname;
                  echo "(Patient)";
                }
...
function auditdump_report_search(){
  ...
  var auditdump_report_hospital        = $(".auditdump_report_hospital").val();
  ...
  $.ajax({
    ...
    url: BASE_URL+"dashboard_super/auditdump/auditdump/auditdump_report_search",

    data: 'auditdump_report_from_datetime='+auditdump_report_from_datetime+'&auditdump_report_to_datetime='+auditdump_report_to_datetime+'&auditdump_report_module='+auditdump_report_module+'&auditdump_report_hospital='+auditdump_report_hospital+'&auditdump_report_medicalprovider='+auditdump_report_medicalprovider+'&auditdump_report_patient='+auditdump_report_patient,
...
function auditdump_report_pdf(){
  ...
  window.location.href='<?php echo base_url(); ?>'+'dashboard_super/auditdump/auditdump/auditdump_report_pdf?'+'from_datetime='+from_datetime+'&to_datetime='+to_datetime+'&report_module='+report_module
...
function auditdump_report_excel(){
  ...
  window.location.href='<?php echo base_url(); ?>'+'dashboard_super/auditdump/auditdump/download_excel?'+'from_datetime='+from_datetime+'&to_datetime='+to_datetime+'&report_module='+report_module
}
