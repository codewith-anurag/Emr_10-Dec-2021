                        ...
                        <tr class="hovertr">
                            ...
                            <td class="pt-20">
                                <div class="btn-group" style="float: right;display: flex;">
                                    <a href="<?php echo base_url('item_master/send_paymentlink/'.$subscribe_list->id.'/'.$subscribe_list->patient_id) ?>" class="btn btn-xs icon-box btn-default" style="margin-right:10px;" onclick="return confirm('Are you sure Resend mail ?')"><i class="fa fa-envelope" aria-hidden="true"></i></a>
                                    <a href="<?php echo base_url('item_master/invoice_pdf/'.$subscribe_list->id.'/'.$subscribe_list->patient_id) ?>" target="_blank" class="btn btn-xs icon-box btn-default" style="margin-right:10px;"><i class="fa fa-file-text" aria-hidden="true"></i></a>                                    
                                    <a href="<?php echo base_url('item_master/delete_subscribe/'.$subscribe_list->id.'/'.$subscribe_list->patient_id) ?>" onclick="return confirm('Are you sure Delete this record?')" class="btn btn-xs btn-danger icon-box" style="margin-right:10px;border:1px solid #f00 !important;"><i class="fa fa-trash"></i></a>
                                </div>
                            </td>
                        </tr>
                        <?php } ?>
                            ...
                            <td class="pt-15">
                                <div class="btn-group" style="float: right;display: flex;">
                                    <button onclick="return edit_subscribe(<?php echo $invoice_list->id ?>);" data-toggle="modal" data-target="#editmyModal" class="btn btn-xs icon-box btn-default" style="margin-right:10px;"><i class="fa fa-edit"></i></button>
                                     <a href="<?php echo base_url('item_master/send_invoice_paymentlink/'.$invoice_list->id.'/'.$invoice_list->patient_id) ?>" class="btn btn-xs icon-box btn-default" style="margin-right:10px;" onclick="return confirm('Are you sure Resend mail ?')"><i class="fa fa-envelope" aria-hidden="true" ></i></a>                                                                
                        ...
                        <tr class="hovertr" style="border-bottom: 1px solid #ccc;">
                            ...
                            <td class="pt-15">
                                <div class="btn-group" style="float: right;display: flex;">
                                    ...
                                    <a href="<?php echo base_url('item_master/delete_communication_log/'.$communication_log_list->id.'/'.$communication_log_list->patient_id) ?>" class="btn btn-xs btn-danger icon-box" style="margin-right:10px;border:1px solid #f00 !important;" onclick="return confirm('Are you sure Delete this record?')"><i class="fa fa-trash"></i></a>
                                </div>
                            </td>
                        </tr>
                    <?php } ?>
                ...
                <table class="table table-border DTable">
                    ...
                    <tbody id="padd">
                        ...
                        <tr class="hovertr">
                            ...
                            <td class="pt-15">
                                <div class="btn-group" style="float: right;display: flex;">
                                       <a href="<?php echo base_url('item_master/invoice_pdf/'.$billing_history_value->id.'/'.$billing_history_value->patient_id) ?>" target="_blank" class="btn btn-xs icon-box btn-default" style="margin-right:10px;"><i class="fa fa-file-text" aria-hidden="true"></i></a>

                                    <a href="<?php echo base_url('item_master/delete_billinghistory/'.$billing_history_value->id.'/'.$patientid) ?>" class="btn btn-xs btn-danger icon-box" style="margin-right:10px;border:1px solid #f00 !important;" onclick="return confirm('Are you sure Delete this record?')"><i class="fa fa-trash"></i></a>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mt-15">
                                <div class="col-12 col-md-6 form-group pl-0">
                                    ...
                                    <select class="form-control select2"  name="item" required id="item" onchange="return calculate_item_price();">
                    ...
                    <form method="POST" id="edit_subscribe">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mt-15">
                                <div class="col-12 col-md-6 form-group pl-0">
                                    <label>Item<span class="imp-red">*</span></label>
                                    <select class="form-control select2"  name="item" required id="edit_item" onchange="return edit_calculate_item_price();">
                                        <option value="" selected="selected">Select Item</option>
                                        <?php
...
function calculate_item_price(){
    ...
    $.ajax({
        url:"<?php echo base_url(); ?>item_master/get_item_info",
        method:"POST",
        data:dataJson,
        success:function(data)
        {
            ...
            $.each(htmldata, function( index, value ) {
                ...
                if(item_id == value.id){                    
                    //$(".select2 option:selected").css("display","none");
                    //$(".select2-results__options li").css("display","none");
                    $('.select2').find('[value='+value.id+']').remove();
...
function save_subscribe(){
    ...
    $.ajax({
        url:"<?php echo base_url(); ?>item_master/insert_subscribe",
        method:"POST",
...
function edit_subscribe(subscribe_id) {
    ...
    $.ajax({
        url:"<?php echo base_url(); ?>item_master/edit_subscribe",
        method:"POST",
        data:dataJson,
        success:function(data)
        {
        ...
        success:function(data)
        {
           // item_Data.splice(0,item_Data.length);
            ...
            $.each(htmldata, function( index, svalue ) {
                ...
                if(item_id == svalue.id){
                    $("#edititem_ids_"+item_id).hide();
                    $('.select2').find('[value='+svalue.id+']').remove();
                }
            });
            if($("#edit_item").val() !=""){
                item_Data.push($("#edit_item").val());
            }   
            $('#edit_item').val(null).trigger('change');          
        }
    });
}
...
function update_invoice(){
    ...
    $.ajax({
        url:"<?php echo base_url(); ?>item_master/update_invoice",
        method:"POST",
