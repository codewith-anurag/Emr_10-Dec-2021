  ...
  <div class="col-lg-12 col-xs-12 p-0">
    <section>
      <header class="panel_header">
        <h2 class="title pull-left" id="form-title">Add Item</h2>
      </header>
      <?php echo form_open_multipart('item_master/upload_item','class="form-inner"') ?>
        ...
        <div class="row ml-10 mr-10">        
            <div class="col-4 col-md-3 form-group">
              <label>Item File<span class="imp-red">*</span></label>
                <input type="file" required=""  name="item_file" class=" text-field"  id="item_file">
            </div>
            <a href="<?php echo base_url().'assets/item.csv' ?>">Item CSV Demo File</a>
        </div>
         </div>
    ...
    <div class="mb-10 mt-10 ml-10">
      ...
      <a href ="<?php echo base_url()."item_master"; ?>" ><button type="button" class="btn btn-default">Close</button></a>
    </div>
  </form>
</section>
</div>
