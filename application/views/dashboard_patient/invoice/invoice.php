                             ...
                             <!-- <td class="pt-20">
                                <div class="btn-group" style="float: right;display: flex;">
                                   <!-- <a href="<?php //echo base_url('item_master/send_paymentlink/'.$subscribe_list->id.'/'.$subscribe_list->patient_id) ?>" class="btn btn-xs icon-box btn-default" style="margin-right:10px;" onclick="return confirm('Are you sure Resend mail ?')"><i class="fa fa-envelope" aria-hidden="true"></i></a>
                                    <a href="<?php //echo base_url('item_master/delete_subscribe/'.$subscribe_list->id.'/'.$subscribe_list->patient_id) ?>" onclick="return confirm('Are you sure Delete this record?')" class="btn btn-xs btn-danger icon-box" style="margin-right:10px;border:1px solid #f00 !important;"><i class="fa fa-trash">
                        ...
                        <tr class="hovertr">
                            ...
                            <td class="pt-15">
                                <!---<div class="btn-group" style="float: right;display: flex;">
                                    ...
                                    <a href="<?php echo base_url('dashboard_patient/invoice/item_master/invoice_pdf/'.$invoice_list->id.'/'.$invoice_list->patient_id) ?>" target="_blank" class="btn btn-xs icon-box btn-default" style="margin-right:10px;"><i class="fa fa-file-text" aria-hidden="true"></i></a>
                                     <a href="<?php echo base_url('dashboard_patient/invoice/item_master/send_invoice_paymentlink/'.$invoice_list->id.'/'.$invoice_list->patient_id) ?>" class="btn btn-xs icon-box btn-default" style="margin-right:10px; height:28px;" target='_blank'><i class="fa fa-credit-card" aria-hidden="true"></i> Pay Now</a>                                                                
                        ...
                        <tr class="hovertr">
                            ...
                            <!-- <td class="pt-15">
                                <div class="btn-group" style="float: right;display: flex;">
                                    ...
                                    <a href="<?php// echo base_url('item_master/delete_billinghistory/'.$billing_history_value->id) ?>" class="btn btn-xs btn-danger icon-box" style="margin-right:10px;border:1px solid #f00 !important;" onclick="return confirm('Are you sure Delete this record?')"><i class="fa fa-trash"></i></a>
